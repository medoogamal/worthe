...
<div class="login-box">
    ...
    <div class="login-logo">
        <a href="../../index2.html"><b>WORTH </b><br> Fashion & products</a>
    ...
    <div class="login-box-body">
        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="text" name="first_name" class="form-control" placeholder="@lang('site.first_name')">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="text" name="last_name" class="form-control" placeholder="@lang('site.last_name')">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                <input type="text" name="address_city" class="form-control" placeholder="@lang('site.address_city')">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="text" name="city" class="form-control" placeholder="@lang('site.city')">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="text" name="street" class="form-control" placeholder="@lang('site.street')">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
            ...
            <a href="{{ route('login') }}" style="display: block; margin-bottom: 10px;">لديك حساب بالفعل؟ تسجيل الدخول</a>

                                                        ...
                                                        @foreach ($category->products as $product)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {{-- check if the product in the card or not  --}} => {{--  class="btn {{ in_array($product->id, $order->products->pluck('id')->toArray()) ? 'btn-default disabled' : 'btn-success add-product-btn' }} btn-sm"> --}}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach ($order->products as $product)
                                        <tr>
                                            ...
                                            <td>{{ $product->name }}</td>
                                            <td><input type="number" name="quantities[]" data-price="{{ number_format($product->sale_price, 2) }}" class="form-control input-sm product-quantity" min="1"  max="{{$product->stock + $product->pivot->quantity}}" value="{{ $product->pivot->quantity }}"></td>
